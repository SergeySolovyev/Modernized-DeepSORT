...
\modernHOTA{} ($+\deltaHOTA$) at \fpsRealtime{}~FPS end-to-end (timed on MOT16-09), a result that is by
...
recall's effect on HOTA is predicted by per-clip detector precision.
