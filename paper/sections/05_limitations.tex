\section{Limitations}
\label{sec:limitations}\label{sec:difficulties}
...
across the sequences we audit (\cref{tab:detector,tab:sweep}), but six clips
...
and ground-truth column-format issues of \cref{sec:difficulties}), so the
